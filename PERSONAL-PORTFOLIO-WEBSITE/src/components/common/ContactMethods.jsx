...
function ContactMethods() {
  return (
    <section className='mx-6 md:mx-15 lg:mx-30 xl:mx-60 2xl:mx-80 my-4 text-center'>
        ...
        <p className='text-white font-serif font-bold text-sm'>Email:
            <span className='text-[#6283ad]'> bayahashim40@gmail.com</span>
        </p>
        <p className='text-white font-serif font-bold text-sm'>Phone: 
        ...
        <p className='text-[#C5C5C5] font-serif text-sm'>*Click the button below to schedule a quick chat with me.*</p>
